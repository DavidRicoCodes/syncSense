...
- Módulos BF-like, Doppler, RTC-SI y utilidades de fusión recuperados del trabajo de laboratorio. El sounding Golay52 BF-like ya dispone de un smoke del framework; Doppler, RTC-SI, fusión y el experimento científico activo completo siguen fuera del recorrido y no sustituyen el modelo externo.
