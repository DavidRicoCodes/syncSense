...
|---|---|---|---|---|---|
| `nosync_passive` | 5G comercial, SSB | PC2, beacons WiFi | PC3 + PC4 separados | Ninguna; combinación aproximada en PC5 | Smokes RX 5G y enlace WiFi independientes implementados; falta ejecución conjunta y timestamps canónicos |
