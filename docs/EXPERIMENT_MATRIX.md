...
|---|---|---|---|---|---|
| `nosync_passive` | 5G comercial, SSB | PC2, beacons WiFi | PC3 + PC4 separados | Ninguna; combinación aproximada en PC5 | Componentes RX/TX básicos disponibles; falta orquestación/fusión padre |
